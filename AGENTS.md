...
- Declare `property string pluginId: "gopassDms"` and `property var pluginService: null`.
...
- No QML linter in this environment; verify via `dms ipc call plugins reload gopassDms` and `journalctl --user -u dms.service`.
